<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BankLoan.aspx.cs" Inherits="QuaintSAMS.Pages.BankLoan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="titleContentPlaceHolder" runat="server">
    <asp:Literal runat="server" Text="Bank Loan"></asp:Literal>
</asp:Content>
