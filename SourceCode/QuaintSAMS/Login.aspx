...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="QuaintSAMS.Login" %>
...
<head runat="server">
    ...
    <title>
        <asp:Literal ID="defaultTitle" runat="server" Text="Higher Study Guideline | Login"></asp:Literal>
    </title>
