<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="CourseList.aspx.cs" Inherits="QuaintSAMS.Account.CourseList" %>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a runat="server" href="~/Account/Course.aspx" class="btn btn-default"><i class="fa fa-plus"></i>Add</a>
                    </li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">
                                    <asp:Label ID="lblTitleStatus" runat="server" Text="Course List"></asp:Label>
                                </h3>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuAction">
                                                                    <li>
                                                                        <asp:LinkButton ID="btnActiveOrDeactive" runat="server" OnCommand="btnActiveOrDeactive_Command" CommandArgument='<%# QuaintPark.QuaintSecurityManager.Encrypt(Eval("CourseId").ToString()) %>'>
                                                                    ...
                                                                    <li>
                                                                        <asp:HyperLink ID="btnEdit" runat="server" NavigateUrl='<%# String.Concat("~/Account/Course.aspx?Id=", QuaintPark.QuaintSecurityManager.EncryptUrl(Eval("CourseId").ToString())) %>'><i class="fa fa-edit text-light-blue"></i>Edit</asp:HyperLink>
                                                                    </li>
                                                                    <li class="list-seperator"></li>
                                                                    <li>
                                                                        <asp:LinkButton ID="btnDelete" runat="server" OnClientClick="return confirm('Are you sure want to delete?')" OnCommand="btnDelete_Command" CommandArgument='<%# QuaintPark.QuaintSecurityManager.Encrypt(Eval("CourseId").ToString()) %>'><i class="fa fa-trash text-red"></i>Delete</asp:LinkButton>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </td>
