<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="Country.aspx.cs" Inherits="QuaintSAMS.Account.Country" %>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a runat="server" href="~/Account/CountryList.aspx" class="btn btn-default"><i class="fa fa-list-alt"></i>List</a>
                    </li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body user-form">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtCountryCodeAlpha2">Two Letter Country Code:</label>
                                        <asp:TextBox ID="txtCountryCodeAlpha2" runat="server" CssClass="form-control" placeholder="Two Letter Country Code"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtCountryCodeAlpha3">Three Letter Country Code:</label>
                                        <asp:TextBox ID="txtCountryCodeAlpha3" runat="server" CssClass="form-control" placeholder="Three Letter Country Code"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
