<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="TutorialList.aspx.cs" Inherits="QuaintSAMS.Account.TutorialList" %>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a runat="server" href="~/Account/Tutorial.aspx" class="btn btn-default"><i class="fa fa-plus"></i>Add</a>
                    </li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">
                                    <asp:Label ID="lblTitleStatus" runat="server" Text="Tutorial List"></asp:Label>
                                </h3>
                                            ...
                                            <asp:Repeater ID="rptrList" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><%# Eval("TutorialCode") %></td>
                                                        <td class="text-left"><%# Eval("Title") %></td>
                                                        <td class="text-left"><%# Eval("Slug") %></td>
                                                        <td class="text-left"><%# Eval("ExternalUrl") %></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuAction">
                                                                    <li>
                                                                        <asp:LinkButton ID="btnActiveOrDeactive" runat="server" OnCommand="btnActiveOrDeactive_Command" CommandArgument='<%# QuaintPark.QuaintSecurityManager.Encrypt(Eval("TutorialId").ToString()) %>'>
                                                                    ...
                                                                    <li>
                                                                        <asp:HyperLink ID="btnEdit" runat="server" NavigateUrl='<%# String.Concat("~/Account/Tutorial.aspx?Id=", QuaintPark.QuaintSecurityManager.EncryptUrl(Eval("TutorialId").ToString())) %>'><i class="fa fa-edit text-light-blue"></i>Edit</asp:HyperLink>
                                                                    </li>
                                                                    <li class="list-seperator"></li>
                                                                    <li>
                                                                        <asp:LinkButton ID="btnDelete" runat="server" OnClientClick="return confirm('Are you sure want to delete?')" OnCommand="btnDelete_Command" CommandArgument='<%# QuaintPark.QuaintSecurityManager.Encrypt(Eval("TutorialId").ToString()) %>'><i class="fa fa-trash text-red"></i>Delete</asp:LinkButton>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </td>
