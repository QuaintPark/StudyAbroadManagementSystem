<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="Ranking.aspx.cs" Inherits="QuaintSAMS.Account.Ranking" %>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a runat="server" href="~/Account/RankingList.aspx" class="btn btn-default"><i class="fa fa-list-alt"></i>List</a>
                    </li>
                </ol>
            </section>
                            ...
                            <div class="box-body user-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtUniversityName">University Name:<span>*</span></label>
                                        <asp:TextBox ID="txtUniversityName" runat="server" CssClass="form-control" placeholder="University Name" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtRank">Rank:<span>*</span></label>
                                        <asp:TextBox ID="txtRank" runat="server" CssClass="form-control" TextMode="Number" placeholder="Rank" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ddlCountry">Country:<span>*</span></label>
                                        <asp:DropDownList ID="ddlCountry" runat="server" CssClass="form-control" AutoPostBack="false"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlCountry" ErrorMessage="Select country" CssClass="msgError" InitialValue="--- Please Select ---"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
