<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="QuaintSAMS.Account.Dashboard" %>
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="small-box bg-gray">
                            <div class="inner">
                                <h3><asp:Label ID="lblTotalBlogPost" runat="server" Text="0"></asp:Label></h3>
                                <p>Total Blog Post</p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-stats-bars"></i>
