<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.Master" AutoEventWireup="true" CodeBehind="LenderBank.aspx.cs" Inherits="QuaintSAMS.Account.LenderBank" %>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a runat="server" href="~/Account/LenderBankList.aspx" class="btn btn-default"><i class="fa fa-list-alt"></i>List</a>
                    </li>
                </ol>
            </section>
                            ...
                            <div class="box-body user-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="txtBankName">Bank Name:<span>*</span></label>
                                        <asp:TextBox ID="txtBankName" runat="server" CssClass="form-control" placeholder="Bank Name" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
